    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      ...
      decorView.setOnApplyWindowInsetsListener { view, insets ->
        ...
        if ((eventsSink != null) and (hasChanged)) {
          ...
          items["statusBarHeight"] = statusBarHeight.toDouble() / dpi
          items["navigationBarHeight"] = navigationBarHeight.toDouble() / dpi
          items["navigationBarWidthRight"] = navigationBarWidthRight.toDouble() / dpi
          items["navigationBarWidthLeft"] = navigationBarWidthLeft.toDouble() / dpi
